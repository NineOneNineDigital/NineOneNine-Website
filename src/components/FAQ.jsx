                    ...
                    <>
                      <dt>
                        <DisclosureButton className="flex w-full items-center justify-between py-6 text-left group">
                          <span className="text-sm font-medium text-ink-50 group-hover:text-gold-400 transition-colors duration-200">
                            {faq.question}
                          </span>
                          <PlusIcon
                            className={`ml-4 h-4 w-4 flex-none text-ink-500 transition-all duration-300 ${
                              open ? "rotate-45 text-gold-400" : ""
                            }`}
                            aria-hidden="true"
                          />
                        </DisclosureButton>
