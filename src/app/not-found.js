      ...
      <main className="relative flex-1 flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 py-32 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="/"
              className="group inline-flex items-center justify-center gap-3 bg-primary text-black font-mono text-xs tracking-[0.2em] uppercase px-6 py-4 hover:bg-primary-400 transition-all duration-300 hover:shadow-[0_0_40px_rgba(205,164,0,0.25)]"
            >
              <span>Back home</span>
              <span
                aria-hidden="true"
            ...
            <a
              href="/#contact"
              className="group inline-flex items-center justify-center gap-3 font-mono text-xs tracking-[0.2em] uppercase text-white/60 px-6 py-4 border border-white/10 hover:border-white/30 hover:text-white transition-all duration-300"
            >
